...
EXPERIMENT_NAME="qwen25vl_7b_sft_v1_16gpu_3_maxturn10"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    +trainer.rollout_data_dir=/mnt/petrelfs/zhaoshitian/vis_tool_train/rollouts/qwen25vl_7b_sft_v1_16gpu_3_maxturn10 \
